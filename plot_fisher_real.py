...
fisher = 'data_real/F_1024_test_simple_1.npz'
basetitle = 'PDF vs moments 256'

fisher2 = 'data_real/F_1024_test_simple_3.npz'

fisher3 = 'data_real/F_1024_test_simple_5.npz'

fisher4 = 'data_real/F_1024_test_simple_7.npz'

fisher5 = 'data_real/F_1024_test_simple_1.npz'
...
for i in range(n):
    for j in range(i):
        ...
        plt.plot([],color='blue',label='PDF')

        plot_fisher(F2, basetitle, i, j, 'green',True)

        plt.plot([],color='green',label='Moment')

        plot_fisher(F3, basetitle, i, j, 'red', False)
            
        plt.plot([],color='red',label='log PDF')
        
        plot_fisher(F4,basetitle,i,j, 'black',False)
        plt.plot([],color='black',label='log Moment')
